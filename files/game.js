    		...
    		if ($$self.$$.dirty & /*stage*/ 1) {
    			 {
    				$$invalidate(1, text = ({
    					...
    					14: "It's time to talk about pollution. Pollution is generated by Kilns and Mine v1s located on Earth. Once a pollution reaches 100000, all of Earth is wiped out. The only way to undo pollution is to build Cleaners on Earth, which subtract one per turn.<br><br>Move back to Earth and build a Cleaner.",
