var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			span = element("span");
    			t = text(t_value);
    			attr(span, "class", "svelte-shfmkx");
    			attr(div, "class", div_class_value = "" + (null_to_empty("deposit-" + /*deposit*/ ctx[4] + " terrain-" + /*terrain*/ ctx[1] + " tiletype-" + /*tiletype*/ ctx[3] + " territory-" + /*territory*/ ctx[2] + (/*selected*/ ctx[5] ? " selected" : "")) + " svelte-shfmkx"));
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*deposit, terrain, tiletype, territory, selected*/ 62 && div_class_value !== (div_class_value = "" + (null_to_empty("deposit-" + /*deposit*/ ctx[4] + " terrain-" + /*terrain*/ ctx[1] + " tiletype-" + /*tiletype*/ ctx[3] + " territory-" + /*territory*/ ctx[2] + (/*selected*/ ctx[5] ? " selected" : "")) + " svelte-shfmkx"))) {
    		...
    		if ($$self.$$.dirty & /*stage*/ 1) {
    			 {
    				$$invalidate(1, text = ({
    					...
    					12: "Alright! Move to a uranium deposit (the little purple squares) and build a Mine v2.",
    					13: "It's time to talk about pollution. Pollution is generated by Kilns and Mine v1s located on Earth. Once a pollution reaches 100000, all of Earth is wiped out. The only way to undo pollution is to build Cleaners on Earth, which subtract one per turn.<br><br>Move back to Earth and build a Cleaner.",
    					14: "Alright! You've reached the end of this tutorial. A couple of things about combat to note:<br><ul><li>Pressing <kbd>N</kbd> will nuke the currently selected tile and all tiles in a 5x5 radius around it. Each nuke adds 2000 pollution.</li><li>Walls are a barrier; an army cannot pass through it unless it has more soldiers than the wall's strength. Iron walls are stronger than copper walls which are stronger than brick walls.</li><li>If you lose all of your Cores, you die, so keep your Cores protected!</li></ul>"
    				})[stage]);
    			}
    		}
    	};
    ...
    function create_if_block_5(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(p0, "class", "svelte-125fzfy");
    			attr(p1, "class", "svelte-125fzfy");
    		},
    		m(target, anchor) {
    ...
    function create_if_block_4(ctx) {
    	...
    	return {
    		c() {
    			h3 = element("h3");
    			h3.textContent = "United States and China blaming each other for climate change";
    			t1 = space();
    			p = element("p");

    			p.innerHTML = `<b>WASHINGTON, D.C.</b> - <span class="blur-s svelte-125fzfy">The United States</span>  <span class="blur-m svelte-125fzfy">and China have been
throwing attacks at</span>  <span class="blur svelte-125fzfy">each other for the past week. It&#39;s important to realize that eu iaculis mauris. 
...
Aenean nulla orci, tempor ac euismod eget, gravida ut dolor.</span>`;

    			attr(h3, "class", "svelte-125fzfy");
    			attr(p, "class", "svelte-125fzfy");
    		},
    		m(target, anchor) {
    ...
    function create_if_block_3(ctx) {
    	...
    	return {
    		c() {
    			...
    			p.innerHTML = `<b>BEIJING</b> - Scientist Liao Shi blamed scientist&#39;s acceptance of Darwin&#39;s theory of evolution
...
theories,&quot; he said at a conference last Friday.`;
    ...
    function create_if_block_2(ctx) {
    	...
    	return {
    		c() {
    			h3 = element("h3");
    			h3.textContent = "Sea level rise worry city officials";
    			t1 = space();
    			p = element("p");
...
who wished to remain anonymous.`;
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "svelte-125fzfy");
    		},
    		m(target, anchor, remount) {
    			insert(target, button, anchor);
    			if (remount) dispose();
    ...
    // (93:0) {#if document < documentcount}
    ...
    function create_fragment$6(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*document*/ ctx[1] === 1) return create_if_block_2;
    		if (/*document*/ ctx[1] === 2) return create_if_block_3;
    		if (/*document*/ ctx[1] === 3) return create_if_block_4;
    		if (/*document*/ ctx[1] === 4) return create_if_block_5;
    	}

    	let current_block_type = select_block_type(ctx);
    	let if_block0 = current_block_type && current_block_type(ctx);
    	let if_block1 = /*document*/ ctx[1] != 1 && create_if_block_1(ctx);
    	let if_block2 = /*document*/ ctx[1] < /*documentcount*/ ctx[0] && create_if_block$1(ctx);
    	...
    	return {
    		c() {
    			...
    			t0 = space();
    			span = element("span");
    			t1 = text(/*document*/ ctx[1]);
    			t2 = text(" / ");
    			t3 = text(/*documentcount*/ ctx[0]);
    			t4 = space();
    			if (if_block1) if_block1.c();
    			t5 = space();
    			if (if_block2) if_block2.c();
    			attr(span, "class", "page svelte-125fzfy");
    			attr(div, "class", "svelte-125fzfy");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*document*/ 2) set_data(t1, /*document*/ ctx[1]);
    			if (dirty & /*documentcount*/ 1) set_data(t3, /*documentcount*/ ctx[0]);
    			...
    			if (/*document*/ ctx[1] < /*documentcount*/ ctx[0]) {
    				if (if_block2) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	let documentcount;
    	let document = 1;
    	const click_handler = () => $$invalidate(1, document -= 1);
    	const click_handler_1 = () => $$invalidate(1, document += 1);

    	$$self.$set = $$props => {
    		if ("documents" in $$props) $$invalidate(2, documents = $$props.documents);
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*documents*/ 4) {
    			 $$invalidate(0, documentcount = Math.min(documents, maxDocuments));
    		}
    	};

    	return [documentcount, document, documents, click_handler, click_handler_1];
    }

    class History extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { documents: 2 });
    	}
    }
    ...
    function create_if_block_2$1(ctx) {
    	...
    	return {
    		...
    		m(target, anchor, remount) {
    			...
    			current = true;
    			if (remount) dispose();
    			dispose = listen(button, "click", /*click_handler*/ ctx[27]);
    		},
    		p(ctx, dirty) {
    ...
    // (191:0) {#if showHistory}
    function create_if_block_1$1(ctx) {
    	let current;

    	const history = new History({
    			props: { documents: /*greenhouses*/ ctx[16] }
    		});
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*greenhouses*/ 65536) history_changes.documents = /*greenhouses*/ ctx[16];
    ...
    function create_fragment$7(ctx) {
    	...
    	function map_selected_binding(value) {
    		/*map_selected_binding*/ ctx[26].call(null, value);
    	}
    	...
    	map.$on("move", /*move*/ ctx[20]);
    	map.$on("make", /*make*/ ctx[21]);
    	map.$on("launch", /*launch*/ ctx[22]);
    	map.$on("nuke", /*nuke*/ ctx[23]);
    	let if_block0 = !/*hide*/ ctx[9] && create_if_block_2$1(ctx);
    	let if_block1 = /*showHistory*/ ctx[17] && create_if_block_1$1(ctx);
    	let if_block2 = /*isTutorial*/ ctx[19] && create_if_block$2(ctx);
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (/*isTutorial*/ ctx[19]) if_block2.p(ctx, dirty);
    		},
    		i(local) {
    			if (current) return;
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	window.addEventListener("keydown", function (e) {
    		...
    		if (e.key == "r") {
    			if (greenhouses != 0) {
    				$$invalidate(17, showHistory = !showHistory);
    			} else {
    				$$invalidate(17, showHistory = false);
    			}
    		}
    	});
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*territory, userIndex, tiletypes, greenhouses*/ 81940) {
    			 {
    				$$invalidate(16, greenhouses = 0);

    				for (let i = 0; i < territory.length; i++) {
    					if (territory[i] == userIndex & tiletypes[i] == "greenhouse") {
    						$$invalidate(16, greenhouses += 1);
    					}
    				}
    			}
    		}
