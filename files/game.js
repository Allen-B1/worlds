...
who wished to remain anonymous.`;
    ...
    function create_fragment$6(ctx) {
    	...
    	let if_block2 = /*document*/ ctx[2] < /*documentcount*/ ctx[1] && create_if_block$1(ctx);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	let if_block = /*tileInfos*/ ctx[15].length == 11 && create_if_block_2$1(ctx);
    ...
    function create_fragment$7(ctx) {
    	...
    	const history = new History({
    			props: {
    				documents: /*greenhouses*/ ctx[16],
    				show: /*showHistory*/ ctx[17]
    			}
    		});

    	let if_block1 = /*isTutorial*/ ctx[19] && create_if_block$2(ctx);
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*showHistory*/ 131072) history_changes.show = /*showHistory*/ ctx[17];
    			history.$set(history_changes);
    			if (/*isTutorial*/ ctx[19]) if_block1.p(ctx, dirty);
    		},
    		i(local) {
    			if (current) return;
...

    	{
    		...
    		for (let kbd of tileKeys) {
    			...
    			xhr.onload = function () {
    				...
    				info.key = kbd;
    				$$invalidate(15, tileInfos[j] = info, tileInfos);
